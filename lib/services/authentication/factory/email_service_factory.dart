...
import 'package:manning_live/services/authentication/factory/base/email_sign_in_service.dart';
import 'package:manning_live/services/firebase/firestore/firestore.dart';

class EmailServiceFactory implements AuthenticationServiceFactory {
  AbstractSignInService create() {
    ...
    return EmailSignInService(_auth, _repository);
  }
}