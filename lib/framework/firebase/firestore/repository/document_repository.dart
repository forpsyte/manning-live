...
class DocumentRepository implements DocumentRepositoryInterface {
  ...
  DocumentRepository(this.collectionName, this.firestore);
  ...
  Future<SearchResults> getList({SearchCriteria searchCriteria}) async {
    try {
      ...
      final List<DocumentModel> documents = query.documents.map((doc) {
        return DocumentModel.fromDocumentSnapshot(doc);
      }).toList();
      final List<DocumentModel> results = searchCriteria == null
          ? documents
